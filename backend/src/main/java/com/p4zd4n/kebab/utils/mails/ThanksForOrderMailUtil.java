...
public class ThanksForOrderMailUtil {
  ...
  private static final String PARAGRAPH_4_ENG =
      "You can track order up to 2 hours from the last update. We will contact you when we prepare your meals. See you soon!";
  private static final String PARAGRAPH_5_FIRST_ENG = "Order ";
  private static final String PARAGRAPH_5_SECOND_ENG =
      " times with this email to receive a discount code for your next order!";
  private static final String PARAGRAPH_6_ENG =
  ...
  private static final String PARAGRAPH_1_FIRST_PL =
      "Dziękujemy za złożenie zamówienia! " + "Masz teraz możliwość śledzić zamówienie klikając ";
  ...
  private static final String PARAGRAPH_4_PL =
      "Zamówienie możesz śledzić do 2 godzin od jego ostatniej aktualizacji. Skontaktujemy się z tobą, gdy przygotujemy Twoje dania. Do zobaczenia!";
  private static final String PARAGRAPH_5_FIRST_PL = "Zamów jeszcze ";
  private static final String PARAGRAPH_5_SECOND_PL =
      " razy z podaniem tego emaila aby otrzymać kod rabatowy na kolejne zamówienie!";
  private static final String PARAGRAPH_6_PL =
  ...
  @Async
  public void sendEng(NewOrderRequest request, Customer customer, Long orderId)
    ...
    Context context =
        getContext(
            ...
            orderId,
            NewsletterMessagesLanguage.ENGLISH);
  ...
  @Async
  public void sendPl(NewOrderRequest request, Customer customer, Long orderId)
      throws MessagingException {
    ...
    Context context =
        getContext(
            ...
            request.customerPhone(),
            orderId,
            NewsletterMessagesLanguage.POLISH);
    String htmlContent = templateEngine.process("thanks-for-order-mail", context);
  ...
  private Context getContext(
      Long orderCount, String phone, Long orderId, NewsletterMessagesLanguage language) {
    ...
    if (language.equals(NewsletterMessagesLanguage.ENGLISH)) {
      ...
      context.setVariables(Map.of("paragraph1simple", PARAGRAPH_1_SIMPLE_ENG));
    } else {
      context.setVariables(
          Map.of(
              "heading", HEADING_PL,
      ...
      context.setVariables(Map.of("paragraph1simple", PARAGRAPH_1_SIMPLE_PL));
    }

    context.setVariables(Map.of("orderId", orderId, "orderRemaining", 10 - (orderCount % 10)));

    if (phone != null) {
      context.setVariables(Map.of("phone", phone));
    }
