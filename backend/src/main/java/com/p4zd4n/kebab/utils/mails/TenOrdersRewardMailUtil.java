...
public class TenOrdersRewardMailUtil implements DiscountCodeSendable {
  ...
  private static final String PARAGRAPH_1_ENG =
      "Thank you for your last 10 orders! We would like to give you this little gift and encourage to take advantage of it next time!";
  ...
  private static final String PARAGRAPH_1_PL =
      "Dziękujemy za twoje ostatnie 10 zamówień! Chcielibyśmy podarować Ci ten mały prezent i zachęcić do wykorzystania go następnym razem!";
