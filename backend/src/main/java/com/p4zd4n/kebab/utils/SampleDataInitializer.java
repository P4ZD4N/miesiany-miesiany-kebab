...
public class SampleDataInitializer implements CommandLineRunner {
  ...
  private void initAddons() {
    ...
    Addon fries140g = Addon.builder().name("Fries (140g)").price(BigDecimal.valueOf(12)).build();

    Addon fries200g = Addon.builder().name("Fries (200g)").price(BigDecimal.valueOf(15)).build();

    Addon nuggets7pcs =
        Addon.builder().name("Nuggets (7pcs)").price(BigDecimal.valueOf(21)).build();

    Addon zapiekanka = Addon.builder().name("Zapiekanka").price(BigDecimal.valueOf(15)).build();
  ...
  private void initIngredients() {
    ...
    Ingredient pita =
        Ingredient.builder().name("Pita").ingredientType(IngredientType.BREAD).build();

    Ingredient tortilla =
        Ingredient.builder().name("Tortilla").ingredientType(IngredientType.BREAD).build();

    Ingredient chicken =
        Ingredient.builder().name("Chicken").ingredientType(IngredientType.MEAT).build();

    Ingredient mutton =
        Ingredient.builder().name("Mutton").ingredientType(IngredientType.MEAT).build();

    Ingredient meatMix =
        Ingredient.builder().name("Meat Mix").ingredientType(IngredientType.MEAT).build();

    Ingredient falafel =
        Ingredient.builder().name("Falafel").ingredientType(IngredientType.MEAT).build();

    Ingredient cabbage =
        Ingredient.builder().name("Cabbage").ingredientType(IngredientType.VEGETABLE).build();

    Ingredient tomato =
        Ingredient.builder().name("Tomato").ingredientType(IngredientType.VEGETABLE).build();

    Ingredient cucumber =
        Ingredient.builder().name("Cucumber").ingredientType(IngredientType.VEGETABLE).build();

    Ingredient onion =
        Ingredient.builder().name("Onion").ingredientType(IngredientType.VEGETABLE).build();

    Ingredient garlicSauce =
        Ingredient.builder().name("Garlic Sauce").ingredientType(IngredientType.SAUCE).build();

    Ingredient bbqSauce =
        Ingredient.builder().name("BBQ Sauce").ingredientType(IngredientType.SAUCE).build();

    Ingredient mildSauce =
        Ingredient.builder().name("Mild Sauce").ingredientType(IngredientType.SAUCE).build();

    Ingredient hotSauce =
        Ingredient.builder().name("Hot Sauce").ingredientType(IngredientType.SAUCE).build();

    Ingredient sauceMix =
        Ingredient.builder().name("Sauce Mix").ingredientType(IngredientType.SAUCE).build();

    Ingredient cheese =
        Ingredient.builder().name("Cheese").ingredientType(IngredientType.OTHER).build();

    Ingredient fries =
        Ingredient.builder().name("Fries").ingredientType(IngredientType.OTHER).build();
  ...
  private void initMeals() {
    ...
    List<Ingredient> salad =
        List.of(
            ingredientRepository
                .findByName("Cabbage")
                .orElseThrow(() -> new IngredientNotFoundException("Cabbage")),
            ingredientRepository
                .findByName("Tomato")
                .orElseThrow(() -> new IngredientNotFoundException("Tomato")),
            ingredientRepository
                .findByName("Cucumber")
                .orElseThrow(() -> new IngredientNotFoundException("Cucumber")),
            ingredientRepository
                .findByName("Onion")
                .orElseThrow(() -> new IngredientNotFoundException("Onion")));
    ...
    Meal pitaKebabSalads =
        Meal.builder().name("Pita Kebab Salads").prices(pitaKebabSaladsPrices).build();

    pitaKebabSalads.addIngredient(
        ingredientRepository
            .findByName("Pita")
            .orElseThrow(() -> new IngredientNotFoundException("Pita")));
    ...
    pitaKebabSaladsAndFries.addIngredient(
        ingredientRepository
            .findByName("Fries")
            .orElseThrow(() -> new IngredientNotFoundException("Fries")));
  ...
  private void initJobOffers() {
    ...
    JobOffer jobOffer1 =
        JobOffer.builder()
            .positionName("Cook")
            .description(
                "We are searching a cook with a lot of passion and with some experience in preparing kebabs!")
    ...
    jobOffer1.addRequirement(
        JobRequirement.builder()
            ...
            .description(
                "1+ year of experience working on the similar position in other Kebab restaurant")
            .build());
    jobOffer1.addRequirement(
        JobRequirement.builder()
            .requirementType(JobRequirementType.MANDATORY)
    ...
    jobOffer1.addRequirement(
        JobRequirement.builder()
            .requirementType(JobRequirementType.MANDATORY)
            .description(
                "Ability to work in a fast-paced setting and manage pressure during peak hours")
            .build());
    jobOffer1.addRequirement(
        JobRequirement.builder()
            .requirementType(JobRequirementType.MANDATORY)
  ...
  private void initPromotions() {
    ...
    MealPromotion largeSizePromotion =
    ...
    BeveragePromotion cocaColaPromotion =
  ...
  private void initOrders() {
    ...
    Meal meal =
        mealRepository
            .findByName("Pita Kebab Salads and Fries")
            .orElseThrow(() -> new RuntimeException("Meal not found"));
    Addon addon =
        addonRepository
            .findByName("Zapiekanka")
            .orElseThrow(() -> new RuntimeException("Addon not found"));
    Beverage beverage =
        beverageRepository
            .findByNameAndCapacity("Coca-Cola", BigDecimal.valueOf(0.33))
  ...
  private void initDiscountCodes() {
    ...
    DiscountCode discountCodeExpired =
        new DiscountCode("expired", BigDecimal.valueOf(20), LocalDate.now().minusMonths(1), 1L);

    discountCodesRepository.save(discountCodeExpired);

    DiscountCode discountCode2 =
        new DiscountCode("kodzik", BigDecimal.valueOf(20), LocalDate.now().plusMonths(1), 3L);
