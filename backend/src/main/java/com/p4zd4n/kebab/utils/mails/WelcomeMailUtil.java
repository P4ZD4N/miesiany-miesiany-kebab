...
public class WelcomeMailUtil {
  ...
  private static final String PARAGRAPH_1_ENG =
      "We are really happy, that you are with us! From now on, whenever a new promotion appears, you will be notified personally!";
  ...
  private static final String PARAGRAPH_1_PL =
      "Bardzo się cieszymy, że z nami jesteś! Od teraz, gdy tylko pojawi się nowa promocja, będziesz o tym powiadomiony osobiście!";
