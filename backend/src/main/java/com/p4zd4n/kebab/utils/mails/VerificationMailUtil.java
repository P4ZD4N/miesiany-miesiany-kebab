...
public class VerificationMailUtil {
  ...
  private static final String PARAGRAPH_1_ENG =
      "Thank you for your desire to subscribe to our newsletter! To confirm your subscription, use the verification code below.";
  ...
  private static final String PARAGRAPH_4_ENG =
      "If you have not requested this code, please ignore this message.";
  private static final String PARAGRAPH_5_ENG =
  ...
  private static final String PARAGRAPH_1_PL =
      "Dziękujemy za chęć zapisania się na nasz newsletter! Aby potwierdzić subskrypcję, użyj poniższego kodu weryfikacyjnego.";
  ...
  private static final String PARAGRAPH_4_PL =
      "Jeśli nie wnioskowałeś o ten kod, prosimy o zignorowanie tej wiadomości.";
  private static final String PARAGRAPH_5_PL =
