...
public class HighValueOrderRewardMailUtil implements DiscountCodeSendable {
  ...
  private static final String PARAGRAPH_1_ENG =
      "Thank you for your high value order! We would like to give you this little gift and encourage to take advantage of it next time!";
  private static final String PARAGRAPH_2_FIRST_ENG = "Your ";
  private static final String PARAGRAPH_2_SECOND_ENG = "% discount code:";
  private static final String PARAGRAPH_3_ENG =
      "This code is valid for one month and can be used once";
  ...
  private static final String PARAGRAPH_1_PL =
      "Dziękujemy za twoje zamówienie o wysokiej wartości! Chcielibyśmy podarować Ci ten mały prezent i zachęcić do wykorzystania go następnym razem!";
  private static final String PARAGRAPH_2_FIRST_PL = "Twój ";
  private static final String PARAGRAPH_2_SECOND_PL = "% kod rabatowy:";
  private static final String PARAGRAPH_3_PL =
      "Kod jest ważny przez miesiąc i można go użyć tylko raz";
  private static final String PARAGRAPH_4_PL =
      "© " + LocalDate.now().getYear() + " Miesiany Miesiany Kebab. Wszelkie prawa zastrzeżone.";

  public HighValueOrderRewardMailUtil(
  ...
  @Async
  public void sendEng(NewOrderRequest request, DiscountCode discountCode)
