...
public class BeverageService {
  ...
  public List<BeverageResponse> getBeverages() {
    ...
    List<BeverageResponse> response =
        beverages.stream().map(this::mapToResponse).collect(Collectors.toList());
  ...
  public Beverage findBeverageByNameAndCapacity(String name, BigDecimal capacity) {
    ...
    Beverage beverage =
        beverageRepository
            .findByNameAndCapacity(name, capacity)
  ...
  public NewBeverageResponse addBeverage(NewBeverageRequest request) {
    ...
    Optional<List<Beverage>> beverages =
        beverageRepository.findByCapacity(request.newBeverageCapacity());

    if (beverages.isPresent() && !beverages.get().isEmpty()) {

      boolean exists =
          beverages.get().stream()
              .anyMatch(
                  beverage ->
  ...
  public UpdatedBeverageResponse updateBeverage(Beverage beverage, UpdatedBeverageRequest request) {
    ...
    Optional<List<Beverage>> beverages =
        beverageRepository.findByCapacity(request.updatedBeverageNewCapacity());
    ...
    UpdatedBeverageResponse response =
