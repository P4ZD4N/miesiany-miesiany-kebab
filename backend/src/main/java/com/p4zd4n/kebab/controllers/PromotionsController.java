...
public class PromotionsController {
  ...
  public ResponseEntity<UpdatedMealPromotionResponse> updateMealPromotion(
    ...
    UpdatedMealPromotionResponse response =
        mealPromotionsService.updateMealPromotion(existingMealPromotion, request);
  ...
  public ResponseEntity<RemovedMealPromotionResponse> removeMealPromotion(
    ...
    RemovedMealPromotionResponse response =
        mealPromotionsService.removeMealPromotion(existingMealPromotion);
  ...
  public ResponseEntity<UpdatedBeveragePromotionResponse> updateBeveragePromotion(
    ...
    BeveragePromotion existingBeveragePromotion =
        beveragePromotionsService.findBeveragePromotionById(request.id());
    UpdatedBeveragePromotionResponse response =
        beveragePromotionsService.updateBeveragePromotion(existingBeveragePromotion, request);

    log.info(
        "Successfully updated beverage promotion with id  '{}'", existingBeveragePromotion.getId());
  ...
  public ResponseEntity<RemovedBeveragePromotionResponse> removeBeveragePromotion(
    ...
    RemovedBeveragePromotionResponse response =
        beveragePromotionsService.removeBeveragePromotion(existingBeveragePromotion);
  ...
  public ResponseEntity<UpdatedAddonPromotionResponse> updateAddonPromotion(
    ...
    AddonPromotion existingAddonPromotion =
        addonPromotionsService.findAddonPromotionById(request.id());
    UpdatedAddonPromotionResponse response =
        addonPromotionsService.updateAddonPromotion(existingAddonPromotion, request);
  ...
  public ResponseEntity<RemovedAddonPromotionResponse> removeAddonPromotion(
    ...
    RemovedAddonPromotionResponse response =
        addonPromotionsService.removeAddonPromotion(existingAddonPromotion);
