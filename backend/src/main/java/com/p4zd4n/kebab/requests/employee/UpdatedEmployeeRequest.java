...
public record UpdatedEmployeeRequest(
        ...
        @Size(max = 20, message = "{firstName.between1And20}")
        String updatedFirstName,

        @JsonProperty("updated_last_name")
        @Size(max = 20, message = "{lastName.between1And20}")
        ...
        @Size(max = 16, message = "{job.between1And16}")
        String updatedJob,
        ...
        @JsonProperty("updated_date_of_birth")
        LocalDate updatedDateOfBirth,

        @JsonProperty("updated_employment_type")
