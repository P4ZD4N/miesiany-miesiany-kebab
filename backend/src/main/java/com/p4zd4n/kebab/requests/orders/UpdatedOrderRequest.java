...
public record UpdatedOrderRequest(
        ...
        @JsonProperty("updated_order_type")
        OrderType orderType,

        @JsonProperty("updated_order_status")
        ...
        @JsonProperty("updated_customer_email")
        @Email(message = "{email.invalidFormat}")
        String customerEmail,

        @JsonProperty("updated_street")
        String street,

        @JsonProperty("updated_house_number")
        Integer houseNumber,

        @JsonProperty("updated_postal_code")
        String postalCode,
