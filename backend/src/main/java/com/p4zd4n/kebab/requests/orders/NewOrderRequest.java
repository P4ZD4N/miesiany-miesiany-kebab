...
public record NewOrderRequest(
    @JsonProperty("order_type") @NotNull(message = "{orderType.notNull}") OrderType orderType,
    @JsonProperty("order_status") @NotNull(message = "{orderStatus.notNull}")
        OrderStatus orderStatus,
    @JsonProperty("customer_phone")
        @Pattern(regexp = "^[0-9]{9}$", message = "{phone.invalidFormat}")
        String customerPhone,
    @JsonProperty("customer_email") @Email(message = "{email.invalidFormat}") String customerEmail,
    String street,
