...
public class BeveragePromotionsServiceTest {
  ...
  @Mock private BeveragePromotionsRepository beveragePromotionsRepository;

  @Mock private BeverageRepository beverageRepository;

  @InjectMocks private BeveragePromotionsService beveragePromotionsService;
  ...
  public void getBeveragePromotions_ShouldReturnBeveragePromotions_WhenCalled() {
    ...
    List<BeveragePromotion> beveragePromotionsList =
        Arrays.asList(
  ...
  public void addBeveragePromotion_ShouldAddBeverage_WhenValidRequestWithNullMapInRequest()
    ...
    BeveragePromotion newBeveragePromotion =
        BeveragePromotion.builder()
    ...
    when(beveragePromotionsRepository.save(any(BeveragePromotion.class)))
        .thenReturn(newBeveragePromotion);
  ...
  public void addBeveragePromotion_ShouldAddBeverage_WhenValidRequestWithNotNullMapInRequest()
    ...
    NewBeveragePromotionRequest request =
        NewBeveragePromotionRequest.builder()
            .description("-10%")
            .discountPercentage(BigDecimal.valueOf(10))
            .beveragesWithCapacities(Map.of("Coca-Cola", List.of(BigDecimal.valueOf(0.5))))
            .build();
  ...
  public void findBeveragePromotionById_ShouldReturnBeveragePromotion_IfExists() {
    ...
    BeveragePromotion foundBeveragePromotion =
        beveragePromotionsService.findBeveragePromotionById(1L);
  ...
  @Test
  public void
      findBeveragePromotionById_ShouldThrowBeveragePromotionNotFoundException_IfDoesNotExists() {

    when(beveragePromotionsRepository.findById(100L))
        .thenThrow(new BeveragePromotionNotFoundException(100L));

    BeveragePromotionNotFoundException exception =
        assertThrows(
            BeveragePromotionNotFoundException.class,
            () -> {
  ...
  public void updateBeveragePromotion_ShouldUpdateBeveragePromotion_WhenValidRequest() {
    ...
    UpdatedBeveragePromotionResponse response =
        beveragePromotionsService.updateBeveragePromotion(beveragePromotion, request);
  ...
  public void removeBeveragePromotion_ShouldRemoveBeveragePromotion_WhenValidRequest() {
    ...
    RemovedBeveragePromotionResponse response =
        beveragePromotionsService.removeBeveragePromotion(beveragePromotion);
