...
public class JobApplicationServiceTest {
    ...
    public void addJobOfferApplication_ShouldAddApplicationToJobOffer_WhenCalled() {
        ...
        JobOffer mockJobOffer = JobOffer.builder()
                .positionName("Cook")
        ...
        assertEquals("Successfully added new job offer application on position 'Cook'", response.message());
    ...
    @Test
    public void addJobOfferApplication_ShouldThrowJobOfferNotFoundException_WhenJobOfferDoesNotExist() {
    ...
    public void addCv_ShouldAddCv_WhenCalled() throws IOException {
        ...
        assertEquals(HttpStatus.OK.value(), response.statusCode());
        assertEquals("Successfully added cv with name 'cv.pdf' to job application with id '1'!", response.message());
    ...
    public void addCv_ShouldThrowJobApplicationFoundException_WhenJobApplicationDoesNotExist() {
        ...
        JobApplicationNotFoundException exception = assertThrows(JobApplicationNotFoundException.class,
    ...
    public void getCv_ShouldRetrieveCv_WhenCalled() {
        ...
        assertEquals("attachment; filename=\"" + cvFileName + "\"", response.getHeaders().getFirst(HttpHeaders.CONTENT_DISPOSITION));
    ...
    public void getCv_ShouldThrowCvNotFoundException_WhenCvNotFound() {
        ...
        CvNotFoundException exception = assertThrows(CvNotFoundException.class,
                () -> jobApplicationService.getCv(cvId));
    ...
    public void removeJobApplication_ShouldRemoveJobApplication_WhenCalled() {
        ...
        RemovedApplicationResponse response = jobApplicationService.removeJobApplication(applicationId, mockJobOffer);
    ...
    @Test
    public void removeJobApplication_ShouldThrowJobApplicationNotFoundException_WhenApplicationDoesNotExist() {
