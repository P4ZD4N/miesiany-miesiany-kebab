...
public class JobOfferServiceTest {
  ...
  @InjectMocks private JobOfferService jobOfferService;
  ...
  public void addJobOffer_ShouldAddJobOffer_WhenJobWithSamePositionDoesNotExist() {
    ...
    when(jobOfferRepository.findByPositionName(request.positionName()))
  ...
  @Test
  public void
      addJobOffer_ShouldThrowJobOfferAlreadyExistsException_WhenJobOfferWithSamePositionDoesNotExist() {
  ...
  @Test
  public void
      findJobOfferByPositionName_ShouldThrowJobOfferNotFoundException_WhenJobOfferDoesNotExist() {

    when(jobOfferRepository.findByPositionName("Cook"))
        .thenThrow(new JobOfferNotFoundException("Cook"));
  ...
  public void updateJobOffer_ShouldUpdateJobOffer_WhenCalled() {
    ...
    when(jobOfferRepository.findByPositionName(jobOffer.getPositionName()))
