...
public class OrdersServiceTest {
  ...
  @Test
  public void addOrder_ShouldThrowDiscountCodeNotFoundException_WhenEnteredNotExistingDiscountCode()
    ...
    when(discountCodesRepository.findByCode("kodzik1"))
        .thenThrow(new DiscountCodeNotFoundException("kodzik1"));
  ...
  @Test
  public void addOrder_ShouldThrowDiscountCodeExpiredException_WhenEnteredExpiredDiscountCode()
      throws MessagingException {
    ...
    when(discountCodesRepository.findByCode("kodzik1"))
        .thenThrow(new DiscountCodeExpiredException("kodzik1"));
  ...
  public void trackOrder_ShouldReturnOrder_WhenOrderExists() {
    ...
    TrackOrderRequest request =
        TrackOrderRequest.builder().id(1L).customerPhone("123456789").build();
  ...
  public void trackOrder_ShouldThrowTrackOrderDataDoesNotMatchException_WhenOrderDataNotMatch() {
    ...
    assertThrows(
        TrackOrderDataDoesNotMatchException.class,
        () -> {
          ordersService.trackOrder(request);
        });
  ...
  public void trackOrder_ShouldThrowTrackOrderExpiredException_WhenLastUpdateOverMaxTime() {
    ...
    assertThrows(
        TrackOrderExpiredException.class,
        () -> {
          ordersService.trackOrder(request);
        });
