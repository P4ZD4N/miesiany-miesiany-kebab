...
public class IngredientServiceTest {
  ...
  @Test
  public void
      findIngredientByName_ShouldThrowIngredientNotFoundException_WhenIngredientDoesNotExist() {

    when(ingredientRepository.findByName("Tortilla"))
        .thenThrow(new IngredientNotFoundException("Tortilla"));
  ...
  public void addIngredient_ShouldThrowIngredientAlreadyExistsException_WhenIngredientExists() {
    ...
    when(ingredientRepository.findByName(request.newIngredientName()))
