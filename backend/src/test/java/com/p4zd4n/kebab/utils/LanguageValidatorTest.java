...
public class LanguageValidatorTest {
    ...
    public void validateLanguage_ShouldThrowInvalidAcceptLanguageHeaderValue_WhenLanguageIsNull() {
        InvalidAcceptLanguageHeaderValue exception = assertThrows(
    ...
    @Test
    public void validateLanguage_ShouldThrowInvalidAcceptLanguageHeaderValue_WhenLanguageIsUnsupported() {
