...
public class DiscountCodesControllerTest {
    ...
    public void getDiscountCodes_ShouldReturnDiscountCodes_WhenCalled() throws Exception {
        ...
        List<DiscountCodeResponse> discountCodeResponses = Arrays.asList(
    ...
    public void getDiscountCode_ShouldReturnDiscountCode_WhenCalled() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/discount-codes/siema"))
                .andExpect(status().isOk())
    ...
    public void getDiscountCode_ShouldReturnNotFound_WhenDiscountCodeDoesNotExist() throws Exception {
        ...
        mockMvc = MockMvcBuilders
                .standaloneSetup(new DiscountCodesController(discountCodesService))
                .setControllerAdvice(exceptionHandler)
                .build();

        mockMvc.perform(get("/api/v1/discount-codes/kodzik")
    ...
    public void addDiscountCode_ShouldReturnOk_WhenValidRequest() throws Exception {
        ...
        NewDiscountCodeRequest request = NewDiscountCodeRequest.builder()
                .code("kodzik")
                .discountPercentage(BigDecimal.valueOf(30))
        ...
        NewDiscountCodeResponse response = NewDiscountCodeResponse.builder()
        ...
        mockMvc.perform(post("/api/v1/discount-codes/add-discount-code")
                .header("Accept-Language", "en")
    ...
    public void updateDiscountCode_ShouldReturnOk_WhenValidRequest() throws Exception {
        ...
        DiscountCode existingDiscountCode = new DiscountCode("kodzik", BigDecimal.valueOf(50), LocalDate.now().plusMonths(1), 2L);
        ...
        when(discountCodesService.findDiscountCodeByCode(request.code())).thenReturn(existingDiscountCode);
        when(discountCodesService.updateDiscountCode(existingDiscountCode, request)).thenReturn(response);

        mockMvc.perform(put("/api/v1/discount-codes/update-discount-code")
                .header("Accept-Language", "en")
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(request)))
                .andExpect(status().isOk())
    ...
    public void removeDiscountCode_ShouldReturnOk_WhenValidRequest() throws Exception {
        ...
        when(discountCodesService.findDiscountCodeByCode(existingDiscountCode.getCode())).thenReturn(existingDiscountCode);
        when(discountCodesService.removeDiscountCode(any(DiscountCode.class))).thenReturn(response);

        mockMvc.perform(delete("/api/v1/discount-codes/remove-discount-code")
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(request)))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.status_code", is(HttpStatus.OK.value())))
