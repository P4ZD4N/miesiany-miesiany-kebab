...
public class NewsletterControllerTest {
  ...
  public void getSubscribers_ShouldReturnSubscribers_WhenCalled() throws Exception {
    ...
    mockMvc
        .perform(get("/api/v1/newsletter/subscribers"))
  ...
  public void subscribe_ShouldReturnOk_WhenValidRequest() throws Exception {
    ...
    NewNewsletterSubscriberResponse response =
        NewNewsletterSubscriberResponse.builder()
            .statusCode(HttpStatus.OK.value())
            .message(
                "Successfully added new newsletter subscriber with email '" + request.email() + "'")
            .build();
  ...
  @Test
  public void subscribe_ShouldReturnConflict_WhenSubscriberWithSameEmailAlreadyExists()
      throws Exception {
    ...
    when(newsletterService.addNewsletterSubscriber(request))
        .thenThrow(new SubscriberAlreadyExistsException(request.email()));
    ...
    mockMvc =
        MockMvcBuilders.standaloneSetup(new NewsletterController(newsletterService))
  ...
  public void subscribe_ShouldReturnBadRequest_WhenInvalidHeader() throws Exception {
    ...
    for (String header : invalidHeaders) {
      mockMvc
          .perform(post("/api/v1/newsletter/subscribe").header("Accept-Language", header))
          .andExpect(status().isBadRequest());
    }
  }
  ...
  public void verifySubscription_ShouldReturnOk_WhenValidRequest() throws Exception {
    ...
    VerifyNewsletterSubscriptionResponse response =
        VerifyNewsletterSubscriptionResponse.builder()
            .statusCode(HttpStatus.OK.value())
  ...
  public void verifySubscription_ShouldReturnConflict_WhenOtpNotMatches() throws Exception {
    ...
    mockMvc
        ...
        .andExpect(
            jsonPath(
                "$.message",
                is("OTP not matching! Please ensure the code was entered correctly!")));
  ...
  public void verifySubscription_ShouldReturnNotFound_WhenSubscriberNotFound() throws Exception {
    ...
    when(newsletterService.verifySubscription(request))
        .thenThrow(new SubscriberNotFoundException(request.email()));
    ...
    mockMvc
        ...
        .andExpect(
            jsonPath(
                "$.message", is("Subscriber with email '" + request.email() + "' not found!")));
  ...
  public void verifySubscription_ShouldReturnBadRequest_WhenInvalidHeader() throws Exception {
    ...
    for (String header : invalidHeaders) {
      mockMvc
          .perform(put("/api/v1/newsletter/verify-subscription").header("Accept-Language", header))
          .andExpect(status().isBadRequest());
    }
  }
  ...
  public void regenerateOtp_ShouldReturnOk_WhenValidRequest() throws Exception {
    ...
    RegenerateOtpResponse response =
        RegenerateOtpResponse.builder()
            .statusCode(HttpStatus.OK.value())
            .message(
    ...
    mockMvc
        ...
        .andExpect(
            jsonPath(
                "$.message",
                is(
                    "Successfully regenerated otp for subscriber with email '"
                        + request.email()
                        + "'!")));
  }
  ...
  public void regenerateOtp_ShouldReturnConflict_WhenOtpRegenerationFails() throws Exception {
    ...
    RegenerateOtpRequest request =
        RegenerateOtpRequest.builder().email("wiko700@gmail.com").build();

    when(newsletterService.regenerateOtp(request))
        .thenThrow(new OtpRegenerationFailedException(OtpUtil.OTP_REGENERATION_TIME_SECONDS));
    ...
    mockMvc
        ...
        .andExpect(jsonPath("$.status_code", is(409)))
        .andExpect(
            jsonPath("$.message", is("OTP regeneration failed! Please try again in a moment!")));
  ...
  public void regenerateOtp_ShouldReturnBadRequest_WhenInvalidHeader() throws Exception {
    ...
    for (String header : invalidHeaders) {
      mockMvc
          .perform(put("/api/v1/newsletter/regenerate-otp").header("Accept-Lan~guage", header))
          .andExpect(status().isBadRequest());
    }
  }
  ...
  public void unsubscribe_ShouldReturnOk_WhenValidRequest() throws Exception {
    ...
    mockMvc
        ...
        .andExpect(
            jsonPath(
                "$.message",
                is("Successfully deleted subscriber with email '" + request.email() + "'!")));
  }

  @Test
  public void unsubscribe_ShouldReturnNotFound_WhenSubscriberNotFound() throws Exception {

    UnsubscribeRequest request = UnsubscribeRequest.builder().email("wiko700@gmail.com").build();

    when(newsletterService.unsubscribe(request))
        .thenThrow(new SubscriberNotFoundException(request.email()));
  ...
  public void unsubscribe_ShouldReturnBadRequest_WhenInvalidHeader() throws Exception {
    ...
    for (String header : invalidHeaders) {
      mockMvc
          .perform(post("/api/v1/newsletter/unsubscribe").header("Accept-Lan~guage", header))
          .andExpect(status().isBadRequest());
    }
  }
}
